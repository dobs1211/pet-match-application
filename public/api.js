 $(document).ready(function() {
             ...
             */
             ...
             $.getJSON('https://crossorigin.me/http://api.petfinder.com/my.method?format=json&key=6d76ac6705f749eb1062fd7d56bd9498&callback=?')
                 .done(function(petApiData) {
                     ...
                     var result = $.ajax({
                             ...
                             url: "https://crossorigin.me/http://api.petfinder.com/pet.find",
                             data: params,
                             dataType: "jsonp",

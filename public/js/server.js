...
var getFromApi = function(endpoint, args) {
    ...
    unirest.get('https://crossorigin.me/http://api.petfinder.com/my.method?format=json&key=6d76ac6705f749eb1062fd7d56bd9498&callback=?' + endpoint)
           .qs(args)
...
var getRelatedFromApi = function(id) {
    var emitter = new events.EventEmitter();
    unirest.get('https://crossorigin.me/http://api.petfinder.com/pet.find')
           .end(function(response) {
                if (response.ok) {
                    emitter.emit('end', response.body);
                }

...
$(document).ready(function () {
    ...
    $('#againButton').click(function () {
        document.getElementById('html').style = "background: rgba(0, 0, 0, 0) url('images/classy_fabric.png') no-repeat center center fixed; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;";
...
function setUpResultScreen() {
    document.getElementById('html').style = "background: rgba(0, 0, 0, 0) url('images/tennis ball.jpg') no-repeat center center fixed; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;";
    var total = 0;
